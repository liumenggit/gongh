...
Page({
  ...
  getList: function (id) {
    ...
    app.util.request({
      ...
      success: function (res) {
        ...
        _this.setData({
          goods_card_1: res.data.prize_card_1,
          goods_card_2: res.data.prize_card_2,
          goods_card_3: res.data.prize_card_3,
  ...
  detail: function (e) {
    ...
    wx.navigateTo({
      url: '../prizeCardDetial/prizeCardDetial?id=' + e.currentTarget.dataset.id,
    })
  },
  /**
   * 生命周期函数--监听页面隐藏
