            ...
            >
                ...
                >
                    ...
                    <tm-image
                        ...
                        :userInteractionEnabled="false"
                        :showLoad="props.showLoad"
                        v-if="item.type == listItemType.community"
                        :src="item.url"
                        :width="props.width"
                        :height="props.height"
                    >
                        <template v-slot:extra>
                            <view class="fulled fulled-height ">
                                <tm-avatar :img="item.avate" class="fixed t-20 r-20"></tm-avatar>
                                <tm-text :label="item.title" color="white" class="fixed b-20 l-20"></tm-text>
                            </view>
                        </template>
                    </tm-image>
                    <tm-image
